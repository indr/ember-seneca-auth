...
describeModule(
  ...
  function () {
    ...
    describe('restore()', function () {
      ...
      it('calls user()', function (done) {
        senecaAuth.user = function () {
          done();
          return RSVP.reject();
        };
      ...
      it('invalid session: rejects with why/reason', function (done) {
        senecaAuth.user = function () {
      ...
      it('invalid session: rejects with no-reason', function (done) {
        senecaAuth.user = function () {
      ...
      it('invalid session: rejects with \'invalid-session\'', function (done) {
        senecaAuth.user = function () {
          // This is how seneca-auth behaves: It returns an object with a single ok:true property if there
          // is no valid session.
      ...
      it('successful restore: resolves with login data', function (done) {
        senecaAuth.user = function () {
      ...
      it('successful restore without token: rejects with no-token', function (done) {
        senecaAuth.user = function () {
          return RSVP.resolve({
            "ok": true,
            "login": {
      ...
      describe('option assignFromUser', function () {
        beforeEach(function () {
          senecaAuth.user = function () {
            return RSVP.resolve(response);
          };
